const Footer = () => {
  const footerLinks = {
    'FIND A STORE': ['Find A Store', 'Become A Member', 'Sign Up for Email', 'Student Discounts', 'Send Us Feedback'],
    'GET HELP': ['Order Status', 'Delivery', 'Returns', 'Payment Options', 'Contact Us'],
    'ABOUT NIKE': ['News', 'Careers', 'Investors', 'Sustainability'],
  };
  ...
  return (
    <footer className="bg-nike-black text-white pt-10">
      {/* Main footer content */}
      <div className="container mx-auto px-4">
        ...
        <div className="flex gap-4 pb-10">
          {socialLinks.map((social) => (
            <a
              key={social.name}
              href="#"
              className="bg-gray-500 hover:bg-white p-2 rounded-full transition-colors"
        ...
        {/* Bottom footer */}
        <div className="flex flex-col md:flex-row justify-between py-6 border-t border-gray-800 text-xs text-gray-400">
